...
## Function for plotting worker barchart:
worker_barchart_plot <- function(input){
        pesticide_worker_plot <- ggbarplot(input,
                                           x = "updated_terms",
                                           y = "weight_ks",
...
## Function for plotting queen barchart:
queen_barchart_plot <- function(input){
        pesticide_queen_plot <- ggbarplot(input,
                                          x = "updated_terms",
                                          y = "weight_ks",
                                          position = position_dodge(0.1),
                                          fill = "category",
...
caste_barchart_plotter <- function(caste){
        ...
        pesticide_caste_BP <- read.table(file = paste("input/",
                                                    caste, "/input_",
                                                    pesticide_abbrev,
                                                    "/BP_sig.txt",
                                                    sep = ""),
        ...
        pesticide_caste_MF <- read.table(file = paste("input/",
                                                    caste, "/input_",
                                                    pesticide_abbrev,
                                                    "/MF_sig.txt",
                                                    sep = ""),
        ...
        pesticide_caste_CC <- read.table(file = paste("input/",
                                                      caste,
                                                      "/input_",
                                                      pesticide_abbrev,
                                                      "/CC_sig.txt",
        ...
        ## Round pvalues for plot:
        pesticide_caste_combined$weight_ks <- round(pesticide_caste_combined$weight_ks,
                                                    digits = 3)
        ...
        pesticide_caste_combined$Term <- factor(pesticide_caste_combined$Term,
                                                levels = pesticide_caste_combined$Term[order(pesticide_caste_combined$category,
                                                                                             pesticide_caste_combined$weight_ks)])
        ## For plotting, update GO term names to include total number of annotated terms:
        pesticide_caste_combined$updated_terms <- paste(pesticide_caste_combined$Term,
                                                        " ", "(", pesticide_caste_combined$Annotated,
                                                        ")", sep = "")
        ## Remove underscore:
