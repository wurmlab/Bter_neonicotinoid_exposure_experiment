...
# Add significance levels to order by significance 
load("input/graphical_representation/de_genes_significance.RData")
significant_de_counts_df_melt$padj <- de_genes_significance
...
plot_heatmap <- function(input) {
                ggplot(input, aes(sample, reorder(gene_name, padj))) +
                ...
                annotate(geom = "text", x = 12, y = 1, label = "*",
