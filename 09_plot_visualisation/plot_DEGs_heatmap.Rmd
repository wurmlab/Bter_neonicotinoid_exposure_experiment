...
libraries <- c("ggplot2", "gplots", "heatmap3", "ggfortify", "rentrez",
               "reshape2", "scales", "ggpubr", "grid", "XML")
...
source("../../code/utility/description_from_LOCid.R")
source("../../code/utility/helper_functions_for_heatmaps.R")
...
## Save output:
ggsave("results/heatmap_figure/combined_worker_queen_heatmap.png", width = 20, height = 18)
```
